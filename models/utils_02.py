...
def match_seq_len(
    c2_seqs, c3_seqs, d_seqs, r_seqs, seq_len, pad_val=-1
):
    '''
        Args:
    ...
    for c2_seq, c3_seq, d_seq, r_seq in zip(
        c2_seqs, c3_seqs, d_seqs, r_seqs
    ):
        i = 0
        while i + seq_len + 1 < len(c2_seq):
    ...
    return proc_c2_seqs, proc_c3_seqs, proc_d_seqs, proc_r_seqs
...
def collate_fn(batch, pad_val=-1):
    '''
        ...
        Returns:
            ...
            d_seqs:
            r_seqs:
            c2shft_seqs: [batch_size, maximum_sequence_length_in_the_batch]
    ...
    for c2_seq, c3_seq, d_seq, r_seq in batch:
    ...
    mask_seqs = (c2_seqs != pad_val) * (c2shft_seqs != pad_val)
    ...
    return c2_seqs, c3_seqs, d_seqs, r_seqs, \
        c2shft_seqs, c3shft_seqs, dshft_seqs, rshft_seqs, \
        mask_seqs
